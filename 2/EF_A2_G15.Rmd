...
logReturns_acf_Returns_oneLag <- acf(compoundedReturns, lag.max = 1, plot = FALSE)$acf[2]
logReturns_acf_squaredReturns_oneLag <- acf(compoundedReturns^2, lag.max = 1, plot = FALSE)$acf[2]

logReturns_summaryStatistics <- data.frame(
  Statistics = c('Mean', 'Std. Deviation', 'Minimum', 'P10', 'Median', 'P90', 'Maximum', 'Skewness', 'Kurtosis', 'Autocorrelation (one lag) of returns', 'Autocorrelation (one lag) of squared returns'),
  Values = round(c(logReturns_mean, logReturns_stdev, logReturns_minimum, logReturns_10_percentile, logReturns_median, logReturns_90_percentile, logReturns_maximum, logReturns_skewness, logReturns_kurtosis,  logReturns_acf_Returns_oneLag, logReturns_acf_squaredReturns_oneLag), 6))
